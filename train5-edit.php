<?php
    ...
    if((isset($_GET['edit']) && $_GET['edit'] != '')){
        ...
        $smarty -> assign('no',$rs['no']);
        $smarty -> assign('name',$rs['name']);
        $smarty -> assign('id',$rs['id']);
        $smarty -> assign('birthday',base64_decode($rs['birthday']));
        $smarty -> assign('phone',base64_decode($rs['phone']));
        $smarty -> assign('postcode',$rs['postcode']);
        $smarty -> assign('address',base64_decode($rs['address']));
        $smarty -> display('train5-edit.html');
